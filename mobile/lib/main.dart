                    ...
                    child: Column(
                      ...
                      ElevatedButton(
                        ...
                        child: _isLoading
                            ...
                            : const Text('Login', style: TextStyle(fontSize: 16, color: white, fontWeight: FontWeight.bold)),
                      ),
                      const SizedBox(height: 16),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      ElevatedButton(
                        ...
                        child: _isLoading
                            ? const CircularProgressIndicator()
                            : const Text('Sign Up', style: TextStyle(fontSize: 16, color: white, fontWeight: FontWeight.bold)),
                      ),
                      const SizedBox(height: 16),
                      if (_errorMessage.isNotEmpty)
                        Text(
